...
#ifndef GRAPHS_ARRAYMATRIX_H
#define GRAPHS_ARRAYMATRIX_H
...
public:
    ...
    ArrayMatrix *vectorMatrixMultiplication(ArrayMatrix *matrix);

    void unionSets(ArrayMatrix *matrix);
    ...
    void printResultToFile(HashTable *label, string filename);

    void printResult(HashTable *label);
